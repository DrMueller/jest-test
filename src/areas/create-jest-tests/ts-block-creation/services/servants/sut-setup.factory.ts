...
export class SutSetupFactory {
  ...
  public create(sutClass: SutClass): ts.ExpressionStatement {
    ...
    const exprs = factory.createExpressionStatement(factory.createCallExpression(
      ...
      [factory.createArrowFunction(
        ...
        factory.createBlock(
          [
            ...mockAssignments,   
            this.createSutAssignment(sutClass)
          ],
          true
        )
      )]
  ...
  private createSutAssignment(sutClass: SutClass): ts.ExpressionStatement {
    const mockedParams = sutClass.constuctor?.parameters.map(param => factory.createAsExpression(
      factory.createIdentifier(param.mockVariableName),
      factory.createTypeReferenceNode(
        factory.createIdentifier(param.typeName),
        undefined
      ))) ?? [];
    ...
    return factory.createExpressionStatement(factory.createBinaryExpression(
      ...
      factory.createNewExpression(
        factory.createIdentifier(sutClass.typeName),
        undefined,
        mockedParams
      )
    ));
